	...
	<div id="wp-bottom-p" class="clearfix">
		...
		<div id="wp-left-p">	
			<div id="wp-details-p">
				...
				<tr class="bidder-name">
					<td><p>Phone*</p></td>
					<td><input name="Phone" type="text" class="forminput" id="Phone" value="" /></td>
				</tr>
				<td><p>Card number*</p></td>
					<td><input name="Card number" type="text" class="forminput" id="Card_number" value="" /></td>
				</tr>
